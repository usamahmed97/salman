...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="my-24 relative mx-auto w-full max-w-7xl bg-white text-gray-700 border border-mattBlack"
    >
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                name="name"
                placeholder="Name"
                className="form-input w-full block shadow-sm rounded border-gray-300 bg-gray-100 text-base placeholder-gray-300 focus:border-mattBlack focus:ring-1 focus:bg-mattBlack"
              />
            </div>
            {/* ::Email Input */}
            <div>
            ...
            <div>
              <button
                type="submit"
                className="py-2 px-6 rounded bg-mattBlack text-base text-white font-semibold uppercase hover:bg-white hover:text-mattBlack hover: border hover:border-mattBlack"
              >
                Send Message
              </button>
            </div>
