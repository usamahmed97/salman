...
const Footer = () => {
  return (
    <footer className="bg-mattBlack text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      <div className="flex items-center justify-center border-b border-t border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        <div className="mr-12 hidden lg:block">
          <span className="text-white">Join us on our social media</span>
        </div>
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p className="text-white">
              A one-stop shop for your company including factoring service,
              dispatch, ELD, and Compliance
            </p>
          </div>
          <div className="">
          ...
          <div>
            ...
            <p className="text-white mb-4 flex items-center justify-center md:justify-start">
              ...
              30 N Gould St Ste, 22088 Sheridan WY, 82801
            </p>
            <p className="text-white mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-mattBlack border-t border-white p-6 text-center dark:bg-neutral-700">
